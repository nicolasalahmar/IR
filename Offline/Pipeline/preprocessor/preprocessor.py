...
if __name__ == '__main__':
    ...
    print(preprocessor("U.S is looking at 1st buying U.K. startup for $1 billion. we walked 15/3. i am eating 10 apples and 3/4 watermelons from UK in the united states of america"))
